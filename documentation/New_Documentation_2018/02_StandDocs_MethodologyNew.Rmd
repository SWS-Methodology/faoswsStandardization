...
table=data.table(read.csv("tables/StandBal/21b_measurementErrors.csv",header = FALSE,check.names = FALSE))
...
table=data.table(read.csv("tables/StandBal/22b_sua_balancedW.csv",check.names = FALSE))
landscape(knitr::kable(table,format = "latex",caption = "Final Balancing - China/Wheat/2014 - Wheat", 
             align = c("r",rep("l",length(colnames(table))-1)),
             col.names = rep("\\boldmath$el$",9)))
