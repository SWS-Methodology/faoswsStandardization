...
```{r f2, fig.align = "center", fig.pos = "H",out.width = "90%",  fig.cap = "\\label{fig:f2}FBS Datasets and their domains in the SWS"}

knitr::include_graphics("images/SwsFbs/02_DatasetsDomains.pdf")
```

```{r f4, fig.align = "center", fig.pos = "H",out.width = "90%",  fig.cap = "\\label{fig:f4}FBS Datatables and their domains in the SWS"}
...
Indeed, three modules are run which have this dataset, as it is at the beginning of the overall process, as, unique or not, inpu:
